...
return array(
    'puzzles' => array(
        ...
        'images' => array(
            ...
            'first_bonus_img' => '/assets/img/hatsu-taoshi-medium.png',
        ),
    ),
    'sound' => array(
        // trueの場合、問題正解時に音を鳴らす
    ...
    'logo_image' => 'burning-ctf-small.png',
    // カウントダウンタイマー
    'countdown' => true,
    // 登録時音声[DOCROOTからの相対パス]
    'register_sound' => '/audio/horagai-final.mp3',
    // 登録時画像[DOCROOTからの相対パス]
    'register_image' => '/assets/img/CTF-GAMBARE-final2.jpg',
);
