...
class Controller_Admin_Bonus extends Controller_Template
{
    ...
    public function action_list()
    {
        ...
        $this->template->content = View::forge('admin/bonus/list', $data);
	...
	$this->template->content = View::forge('admin/bonus/delete', $data);
	$this->template->footer = View::forge('admin/bonus/footer');
    }
	...
	if (Input::method() == 'POST')
	{
	    ...
	    if ($val->run())
	    {
                if ($uid = Model_Score::get_uid($username))
                {
                    ...
                    $this->template->content = View::forge('admin/bonus/created', $data);
                    $this->template->footer = View::forge('admin/bonus/footer');
                    return;
                }
                else
	...
	$this->template->content = View::forge('admin/bonus/create', $data);
