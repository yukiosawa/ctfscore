...
<form class="form-horizontal" action="/auth/updated" method="POST">
  ...
  <div class="form-group">
    <label class="col-md-2 control-label" for="oldpassword">旧秘文</label>
    <div class="col-md-4">
      <input class="form-control" id="oldpassword" type="password" name="old_password" value="" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-md-2 control-label" for="newpassword">新秘文</label>
    <div class="col-md-4">
  ...
  <div class="form-group">
    <div class="col-md-offset-2 col-md-4">
      <button type="submit" class="btn btn-primary">秘文更新</button>
    </div>
  </div>
</form>
