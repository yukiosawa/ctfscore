...
<p>
  秘文を忘れるとログインできませんので注意してください。(リセットはできません)
</p>
...
<form class="form-horizontal" action="/auth/created" method="POST">
  ...
  <div class="form-group">
    <label class="col-md-2 control-label" for="password">秘文</label>
    <div class="col-md-4">
      <input class="form-control" id="password" type="password" name="password" value="" />
    </div>
  </div>
  <div class="form-group">
    <label class="col-md-2 control-label" for="password-confirm">秘文確認</label>
    <div class="col-md-4">
