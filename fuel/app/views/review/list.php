    ...
    <table id="review-table" class="table table-hover tablesorter">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><div class="review" data-number="<?php echo \Model_Config::get_value('max_review_score');?>" data-score="<?php echo $item['score']; ?>"><span style="display:none"><?php echo $item['score']; ?></span></div></td>
