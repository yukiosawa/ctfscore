...
<form action="<?php echo $action ?>" method="post">
  ...
  <div class="form-group">
    ...
    <option value="<?php echo $puzzle['puzzle_id']; ?>" <?php if($puzzle['puzzle_id'] == $puzzle_id) echo " selected" ?>><?php echo $puzzle['puzzle_id'].': '.$puzzle['title'] ?></option>
      <?php endforeach; ?>
    </select>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="review-edit" data-number="<?php echo \Model_Config::get_value('max_review_score');?>" data-score="<?php echo $score; ?>"></div>
    <input type="hidden" class="form-control" id="review-score" name="score" value="<?php echo $score; ?>"></input>
  </div>

  <div class="form-group">
    <label for="comment">公開コメント（建前）【全ユーザに公開：フラグや解き方のヒントは厳禁】</label>
  ...
  <div class="form-group">
    <label for="secret_comment">管理者へのメッセージ（本音）【非公開】</label>
